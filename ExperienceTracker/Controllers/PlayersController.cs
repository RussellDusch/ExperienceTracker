...
namespace ExperienceTracker.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public PlayersController(ExperienceTrackerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,Id")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id")] Player player)
        {
            if (id != player.Id)
            {
                return NotFound();
